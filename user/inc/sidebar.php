    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="add-s.php"><i class="fa fa-fw  fa-location-arrow"></i>Order Software</a>
...
<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="add-c.php"><i class="fa fa-fw fa-plus"></i>Make Complain</a>
