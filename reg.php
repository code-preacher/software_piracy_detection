...
if ($da) {
$_SESSION['dmsg']='<div class="alert alert-success hide alert-dismissible fade show" role="alert">
  ...
  $_SESSION['dmsg']='<div class="alert alert-danger hide alert-dismissible fade show" role="alert">
